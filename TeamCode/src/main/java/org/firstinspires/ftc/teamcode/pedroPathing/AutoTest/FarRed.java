...
@Autonomous(name = "&RedFarTest", group = "Autonomous")
@Configurable
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path0 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(87.279, 7.803),

                                    new Pose(84.197, 23.607)
                            )
